...
# ---- PAGE CONFIG ----
st.set_page_config(
    page_title='Safe Superintelligence vs Peers | Analytics',
    layout='wide',
...
# ---- TITLE & INTRO ----
st.title("🧠 Safe Superintelligence vs the AI World")
st.markdown("A deep-dive into how **Safe Superintelligence** compares to the top players in the AI startup ecosystem using publicly available data.")
...
with tabs[0]:
    ...
    st.markdown('<div class="caption-text">Each company’s funding is compared against its employee growth rate. Safe Superintelligence appears as a high-growth, well-funded outlier.</div>', unsafe_allow_html=True)
