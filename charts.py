...
grok_metrics = {
    "company_name": "Safe Superintelligence",
    "valuation_clean": 32_000_000_000,         # $32B valuation per April 2025 raise :contentReference[oaicite:1]{index=1}
    "total_funding_clean": 3_000_000_000,      # $1B in Sept 2024 + $2B in April 2025 :contentReference[oaicite:2]{index=2}
    "current_employees": 20,                   # ~20 employees as of March 2025 :contentReference[oaicite:3]{index=3}
    "founded": 2024,                           # Launched June 19, 2024 :contentReference[oaicite:4]{index=4}
    "employee_growth": 10,                   # Still pre-product; no historical headcount data to compute growth rate reliably
    "funding_per_employee": 3_000_000_000 / 20,
    "valuation_per_employee": 32_000_000_000 / 20,
    "capital_efficiency": 32_000_000_000 / 3_000_000_000,
}
...
def valuation_bar_chart(df):
    ...
    fig.add_hline(y=grok_metrics["valuation_clean"],
                  ...
                  annotation_text="Safe Superintelligence",
...
def growth_scatter_plot(df):
    ...
    fig.add_trace(go.Scatter(
        ...
        marker=dict(
            ...
            symbol='star'  # unique shape (optional)
        ),
        name='Safe Superintelligence',
        text=['Safe Superintelligence'],
